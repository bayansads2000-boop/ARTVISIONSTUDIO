    ...
    <div class="container">
        <div style="text-align: center; margin-bottom: 80px;">
            <h1 style="font-size: 4rem; font-weight: 900; margin-bottom: 20px;">
                {$lang === "ar" ? "خدماتنا الإبداعية" : "Our Creative Services"}
            </h1>
            <p
                style="font-size: 1.2rem; color: var(--text-muted); max-width: 700px; margin: 0 auto;"
            >
                {$lang === "ar"
                    ? "نقدم حلولاً متكاملة تجمع بين الفن والتقنية لنساعد علامتك التجارية على النمو والتميز في الفضاء الرقمي."
                    : "We provide integrated solutions that combine art and technology to help your brand grow and excel in the digital space."}
            </p>
        </div>
        ...
        <div style="display: grid; gap: 40px;">
            {#each data.services as service, i}
                ...
                >
                    ...
                    >
                        <div
                            style="font-size: 6rem; margin-bottom: 20px; filter: drop-shadow(0 0 20px rgba(227,30,36,0.3));"
                        >
                            {service.icon}
                        </div>
                    </div>
